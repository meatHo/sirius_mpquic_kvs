...
int main(int argc, char**argv){
    ...
    while (keepRunning) {
        ...
        if (w > 0 && h > 0 && gst_buffer_map(buf, &map, GST_MAP_READ)) {
            ...
            cv::imshow("V2X Video Stream Receiver", frame);
        ...
        //     char timeStr[32];
        //     snprintf(timeStr, sizeof(timeStr), "R:%05lld", (long long)ms);
        //     cv::putText(frame, timeStr, cv::Point(30, 120),
